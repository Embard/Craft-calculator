...
GZ.ITEMS = {
  ...
  cloth: {
    ...
    where:
      "Жилые дома, шкафы, склады, военные и промышленные точки. Для рецепта нужен полный запас на 100 единиц."
  },
  ...
  armor_plate: {
    ...
    where:
      "Военные базы высокого уровня: Тисы, СЗ аэродром, Каменск, укреплённые точки. Иногда стоят уже внутри найденных бронежилетов. Ищите в оружейных и на крушениях."
  },
  ...
  rope: {
    ...
    where:
      "Ищется в схронах. Также встречается в сараях, на фермах, в промзонах и гаражах — проверяйте тайники и ящики."
  },
